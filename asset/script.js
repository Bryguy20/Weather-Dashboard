var apiKey = "85128043aa0e0cfae6df2692ad9f9b39";
var today = moment().format('L');
var searchHistoryList = [];


function currentCondition(city) {
    var queryURL = `http://api.openweathermap.org/geo/1.0/direct?q=${city}&units=imperial&appid=${apiKey}`;
    ...
    $.ajax({
        ...
        var  currURL = `http://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=${apiKey}`;
            ...
            if (uvIndex >= 0 && uvIndex <= 2){
                $("#uvIndexColor").css("background-color", "#3EA72D").css("color", "white");
                    ...
                    $("#uvIndexColor").css("background-color", "#E53210").css ("color", "white");
                      ...
                      $("#uvIndeColor").css("background-color", "#B567A4").css("color", "white");
                };
        });
        })
